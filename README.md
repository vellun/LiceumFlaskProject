...
#### Адреса страниц для api:

```
Получение всех туров - /api/tours
Получение одного тура- /api/tours/<tour_id>
Получение всех пользователей - /api/users
Получение одного пользователя - /api/users/<user_id>
```
